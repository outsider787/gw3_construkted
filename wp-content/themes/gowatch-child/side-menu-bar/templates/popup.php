...
<style type="text/css">
    ...
    <?php if($top): ?> top: <?php echo $top; ?>;
    <?php endif;//end $top ?>
    }

    #c9popup<?php echo $key; ?> .content-wrapper {
    <?php if($width): ?> width: <?php echo $width; ?>;
    <?php endif;//end $width ?><?php if($height): ?> height: <?php echo $height; ?>;
...
<script type="text/javascript">
    jQuery(function ($) {
        var c9popupBtn = document.getElementById("c9popup<?php echo $key; ?>-btn");
        var c9popup = document.querySelector("#c9popup<?php echo $key; ?>");
        var closeBtn = document.querySelector("#c9popup<?php echo $key; ?> .close-btn");
